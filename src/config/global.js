  ...
  menuPrincipal: {
    ...
    subMenu: [
      ...
      },
      {
        ...
        download: 'downloads/722103_CF06_DU.pdf',
      },
      {
      ...
      autores: [
        {
          ...
          centro:
            'Centro Industrial del Diseño y la Manufactura - Regional Atlántico',
        },
        {
          nombre: 'Carolina Coca Salazar',
